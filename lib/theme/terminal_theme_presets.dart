...
class TerminalThemePresets {
  static const obsidian = TerminalThemePreset(
    ...
    palette: AppThemePalette(
      ...
      cardSurfaceHover: Color(0xFF2D333B),
  ...
  static const catppuccinMocha = TerminalThemePreset(
    ...
    palette: AppThemePalette(
      ...
      cardSurface: Color(0xFF24273A),
      cardSurfaceHover: Color(0xFF313244),
  ...
  static const dracula = TerminalThemePreset(
    id: 'dracula',
    name: 'Dracula',
    description: 'Classic dark theme with vibrant neon highlights',
    theme: TerminalTheme(
      cursor: Color(0xFF50FA7B),
      selection: Color(0x7744475A),
    ...
    palette: AppThemePalette(
      ...
      textSecondary: Color(0xFF95A1CE),
